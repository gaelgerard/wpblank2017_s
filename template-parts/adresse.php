<div class="adresse">
					   ...
					   $nom_societe2 = get_theme_mod( 'nom_societe2' );
					    if (!empty($nom_societe) || !empty($nom_societe2)) { ?>
						...
						<p><?php echo  __('Tel.', 'html5blank') ?>: <a href="tel:<?php echo $tel_url; ?>"><?php echo $tel; ?></a></p>
						<?php
						elseif (!empty($tel) && empty($tel_url)):?>
						<p><?php echo  __('Tel.', 'html5blank') ?><?php echo $tel; ?></p>
						<?php endif; ?>
						<?php if (!empty($fax)):?>
						<p><?php echo  __('Fax', 'html5blank') ?>: <?php echo $fax; ?></p>
						<?php endif; ?>
						<?php if (!empty($email)):?>
